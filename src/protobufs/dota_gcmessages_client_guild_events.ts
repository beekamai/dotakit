...
export const CMsgGuildContract: MessageFns<CMsgGuildContract> = {
  encode(message: CMsgGuildContract, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CMsgGuildContract {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          message.contractId = reader.uint64().toString();
          continue;
        }
        case 2: {
          if (tag !== 16) {
...
export const CMsgGuildContractSlot: MessageFns<CMsgGuildContractSlot> = {
  encode(message: CMsgGuildContractSlot, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.contract !== undefined) {
      CMsgGuildContract.encode(message.contract, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): CMsgGuildContractSlot {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CMsgAccountGuildEventData: MessageFns<CMsgAccountGuildEventData> = {
  encode(message: CMsgAccountGuildEventData, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    for (const v of message.contractSlots) {
      CMsgGuildContractSlot.encode(v!, writer.uint32(26).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CMsgAccountGuildEventData {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CMsgGuildActiveContracts: MessageFns<CMsgGuildActiveContracts> = {
  encode(message: CMsgGuildActiveContracts, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.contractsRefreshedTimestamp !== 0) {
      writer.uint32(8).uint32(message.contractsRefreshedTimestamp);
    }
    for (const v of message.contracts) {
      CMsgGuildContract.encode(v!, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): CMsgGuildActiveContracts {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CMsgGuildChallenge: MessageFns<CMsgGuildChallenge> = {
  encode(message: CMsgGuildChallenge, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.challengeInstanceId !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CMsgGuildChallenge {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CMsgGuildEventMember: MessageFns<CMsgGuildEventMember> = {
  encode(message: CMsgGuildEventMember, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CMsgGuildEventMember {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CMsgClientToGCRequestAccountGuildEventData: MessageFns<CMsgClientToGCRequestAccountGuildEventData> = {
  encode(message: CMsgClientToGCRequestAccountGuildEventData, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CMsgClientToGCRequestAccountGuildEventData {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CMsgClientToGCRequestAccountGuildEventDataResponse: MessageFns<
...
> = {
  encode(
    ...
    if (message.eventData !== undefined) {
      CMsgAccountGuildEventData.encode(message.eventData, writer.uint32(26).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): CMsgClientToGCRequestAccountGuildEventDataResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CMsgGCToClientAccountGuildEventDataUpdated: MessageFns<CMsgGCToClientAccountGuildEventDataUpdated> = {
  encode(message: CMsgGCToClientAccountGuildEventDataUpdated, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.guildId !== 0) {
      writer.uint32(8).uint32(message.guildId);
    }
    if (message.eventId !== 0) {
    ...
    if (message.guildEventData !== undefined) {
      CMsgAccountGuildEventData.encode(message.guildEventData, writer.uint32(34).fork()).join();
    }
    if (message.contractsUpdated !== false) {
      writer.uint32(40).bool(message.contractsUpdated);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): CMsgGCToClientAccountGuildEventDataUpdated {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CMsgClientToGCRequestActiveGuildContracts: MessageFns<CMsgClientToGCRequestActiveGuildContracts> = {
  encode(message: CMsgClientToGCRequestActiveGuildContracts, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.guildId !== 0) {
      writer.uint32(8).uint32(message.guildId);
    }
    if (message.eventId !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CMsgClientToGCRequestActiveGuildContracts {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CMsgClientToGCRequestActiveGuildContractsResponse: MessageFns<
...
> = {
  encode(
    ...
    if (message.activeContracts !== undefined) {
      CMsgGuildActiveContracts.encode(message.activeContracts, writer.uint32(18).fork()).join();
    }
    if (message.activeChallenges !== undefined) {
      CMsgGuildChallenge.encode(message.activeChallenges, writer.uint32(26).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): CMsgClientToGCRequestActiveGuildContractsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CMsgGCToClientActiveGuildContractsUpdated: MessageFns<CMsgGCToClientActiveGuildContractsUpdated> = {
  encode(message: CMsgGCToClientActiveGuildContractsUpdated, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.guildId !== 0) {
      writer.uint32(8).uint32(message.guildId);
    }
    if (message.eventId !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CMsgGCToClientActiveGuildContractsUpdated {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CMsgClientToGCSelectGuildContract: MessageFns<CMsgClientToGCSelectGuildContract> = {
  encode(message: CMsgClientToGCSelectGuildContract, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.guildId !== 0) {
      writer.uint32(8).uint32(message.guildId);
    }
    if (message.eventId !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CMsgClientToGCSelectGuildContract {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CMsgClientToGCSelectGuildContractResponse: MessageFns<CMsgClientToGCSelectGuildContractResponse> = {
  encode(message: CMsgClientToGCSelectGuildContractResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.result !== 0) {
      writer.uint32(8).int32(message.result);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CMsgClientToGCSelectGuildContractResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CMsgClientToGCRequestActiveGuildChallenge: MessageFns<CMsgClientToGCRequestActiveGuildChallenge> = {
  encode(message: CMsgClientToGCRequestActiveGuildChallenge, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.guildId !== 0) {
      writer.uint32(8).uint32(message.guildId);
    }
    if (message.eventId !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CMsgClientToGCRequestActiveGuildChallenge {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CMsgClientToGCRequestActiveGuildChallengeResponse: MessageFns<
...
> = {
  encode(
    ...
    if (message.activeChallenge !== undefined) {
      CMsgGuildChallenge.encode(message.activeChallenge, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): CMsgClientToGCRequestActiveGuildChallengeResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CMsgGCToClientActiveGuildChallengeUpdated: MessageFns<CMsgGCToClientActiveGuildChallengeUpdated> = {
  encode(message: CMsgGCToClientActiveGuildChallengeUpdated, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.guildId !== 0) {
      writer.uint32(8).uint32(message.guildId);
    }
    if (message.eventId !== 0) {
    ...
    if (message.activeChallenge !== undefined) {
      CMsgGuildChallenge.encode(message.activeChallenge, writer.uint32(26).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): CMsgGCToClientActiveGuildChallengeUpdated {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CMsgClientToGCRequestGuildEventMembers: MessageFns<CMsgClientToGCRequestGuildEventMembers> = {
  encode(message: CMsgClientToGCRequestGuildEventMembers, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.guildId !== 0) {
      writer.uint32(8).uint32(message.guildId);
    }
    if (message.eventId !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CMsgClientToGCRequestGuildEventMembers {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CMsgClientToGCRequestGuildEventMembersResponse: MessageFns<
...
> = {
  encode(
    ...
    for (const v of message.members) {
      CMsgGuildEventMember.encode(v!, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): CMsgClientToGCRequestGuildEventMembersResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CMsgGuildLeaderboardCombinedResponse: MessageFns<CMsgGuildLeaderboardCombinedResponse> = {
  encode(message: CMsgGuildLeaderboardCombinedResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.eventId !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CMsgGuildLeaderboardCombinedResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CMsgClientToGCClaimLeaderboardRewards: MessageFns<CMsgClientToGCClaimLeaderboardRewards> = {
  encode(message: CMsgClientToGCClaimLeaderboardRewards, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.guildId !== 0) {
      writer.uint32(8).uint32(message.guildId);
    }
    if (message.eventId !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CMsgClientToGCClaimLeaderboardRewards {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CMsgClientToGCClaimLeaderboardRewardsResponse: MessageFns<CMsgClientToGCClaimLeaderboardRewardsResponse> =
  {
    encode(
    ...
    decode(input: BinaryReader | Uint8Array, length?: number): CMsgClientToGCClaimLeaderboardRewardsResponse {
      const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
      let end = length === undefined ? reader.len : reader.pos + length;
    ...
    fromJSON(object: any): CMsgClientToGCClaimLeaderboardRewardsResponse {
      return {
        result: isSet(object.result)
          ? cMsgClientToGCClaimLeaderboardRewardsResponse_EResponseFromJSON(object.result)
          : 0,
