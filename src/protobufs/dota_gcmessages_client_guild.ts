...
export const CMsgGuildInfo: MessageFns<CMsgGuildInfo> = {
  encode(message: CMsgGuildInfo, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CMsgGuildInfo {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 9: {
          ...
          message.guildChatGroupId = reader.uint64().toString();
          continue;
        }
        case 10: {
          if (tag !== 82) {
        ...
        case 11: {
          ...
          message.defaultChatChannelId = reader.uint64().toString();
          continue;
        }
        case 12: {
          if (tag !== 96) {
...
export const CMsgGuildSummary: MessageFns<CMsgGuildSummary> = {
  encode(message: CMsgGuildSummary, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.guildInfo !== undefined) {
      CMsgGuildInfo.encode(message.guildInfo, writer.uint32(10).fork()).join();
    }
    if (message.memberCount !== 0) {
      writer.uint32(16).uint32(message.memberCount);
    }
    for (const v of message.eventPoints) {
      CMsgGuildSummary_EventPoints.encode(v!, writer.uint32(26).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): CMsgGuildSummary {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CMsgGuildSummary_EventPoints: MessageFns<CMsgGuildSummary_EventPoints> = {
  encode(message: CMsgGuildSummary_EventPoints, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CMsgGuildSummary_EventPoints {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CMsgGuildRole: MessageFns<CMsgGuildRole> = {
  encode(message: CMsgGuildRole, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.roleId !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CMsgGuildRole {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CMsgGuildMember: MessageFns<CMsgGuildMember> = {
  encode(message: CMsgGuildMember, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CMsgGuildMember {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CMsgGuildInvite: MessageFns<CMsgGuildInvite> = {
  encode(message: CMsgGuildInvite, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CMsgGuildInvite {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CMsgGuildData: MessageFns<CMsgGuildData> = {
  encode(message: CMsgGuildData, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.guildId !== 0) {
      writer.uint32(8).uint32(message.guildId);
    }
    if (message.guildInfo !== undefined) {
      CMsgGuildInfo.encode(message.guildInfo, writer.uint32(18).fork()).join();
    }
    for (const v of message.guildRoles) {
      CMsgGuildRole.encode(v!, writer.uint32(26).fork()).join();
    }
    for (const v of message.guildMembers) {
      CMsgGuildMember.encode(v!, writer.uint32(34).fork()).join();
    }
    for (const v of message.guildInvites) {
      CMsgGuildInvite.encode(v!, writer.uint32(42).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): CMsgGuildData {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CMsgAccountGuildInvite: MessageFns<CMsgAccountGuildInvite> = {
  encode(message: CMsgAccountGuildInvite, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.guildId !== 0) {
      writer.uint32(8).uint32(message.guildId);
    }
    if (message.requesterAccountId !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CMsgAccountGuildInvite {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CMsgAccountGuildMemberships: MessageFns<CMsgAccountGuildMemberships> = {
  encode(message: CMsgAccountGuildMemberships, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    writer.join();
    for (const v of message.guildInvites) {
      CMsgAccountGuildInvite.encode(v!, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): CMsgAccountGuildMemberships {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CMsgGuildPersonaInfo: MessageFns<CMsgGuildPersonaInfo> = {
  encode(message: CMsgGuildPersonaInfo, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.guildId !== 0) {
      writer.uint32(8).uint32(message.guildId);
    }
    if (message.guildTag !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CMsgGuildPersonaInfo {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CMsgAccountGuildsPersonaInfo: MessageFns<CMsgAccountGuildsPersonaInfo> = {
  encode(message: CMsgAccountGuildsPersonaInfo, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.guildPersonaInfos) {
      CMsgGuildPersonaInfo.encode(v!, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): CMsgAccountGuildsPersonaInfo {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CMsgGuildFeedEvent: MessageFns<CMsgGuildFeedEvent> = {
  encode(message: CMsgGuildFeedEvent, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CMsgGuildFeedEvent {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CMsgClientToGCCreateGuild: MessageFns<CMsgClientToGCCreateGuild> = {
  encode(message: CMsgClientToGCCreateGuild, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.guildInfo !== undefined) {
      CMsgGuildInfo.encode(message.guildInfo, writer.uint32(10).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CMsgClientToGCCreateGuild {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CMsgClientToGCCreateGuildResponse: MessageFns<CMsgClientToGCCreateGuildResponse> = {
  encode(message: CMsgClientToGCCreateGuildResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.result !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CMsgClientToGCCreateGuildResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CMsgClientToGCSetGuildInfo: MessageFns<CMsgClientToGCSetGuildInfo> = {
  encode(message: CMsgClientToGCSetGuildInfo, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.guildId !== 0) {
      writer.uint32(8).uint32(message.guildId);
    }
    if (message.guildInfo !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CMsgClientToGCSetGuildInfo {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CMsgClientToGCSetGuildInfoResponse: MessageFns<CMsgClientToGCSetGuildInfoResponse> = {
  encode(message: CMsgClientToGCSetGuildInfoResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.result !== 0) {
      writer.uint32(8).int32(message.result);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CMsgClientToGCSetGuildInfoResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CMsgClientToGCRequestGuildData: MessageFns<CMsgClientToGCRequestGuildData> = {
  encode(message: CMsgClientToGCRequestGuildData, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.guildId !== 0) {
      writer.uint32(8).uint32(message.guildId);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CMsgClientToGCRequestGuildData {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CMsgClientToGCRequestGuildDataResponse: MessageFns<CMsgClientToGCRequestGuildDataResponse> = {
  encode(message: CMsgClientToGCRequestGuildDataResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.result !== 0) {
      writer.uint32(8).int32(message.result);
    }
    if (message.guildData !== undefined) {
      CMsgGuildData.encode(message.guildData, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): CMsgClientToGCRequestGuildDataResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CMsgGCToClientGuildDataUpdated: MessageFns<CMsgGCToClientGuildDataUpdated> = {
  encode(message: CMsgGCToClientGuildDataUpdated, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.guildData !== undefined) {
      CMsgGuildData.encode(message.guildData, writer.uint32(10).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CMsgGCToClientGuildDataUpdated {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CMsgGCToClientGuildMembersDataUpdated: MessageFns<CMsgGCToClientGuildMembersDataUpdated> = {
  encode(message: CMsgGCToClientGuildMembersDataUpdated, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.guildId !== 0) {
      writer.uint32(8).uint32(message.guildId);
    }
    for (const v of message.membersData) {
      CMsgGuildMember.encode(v!, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): CMsgGCToClientGuildMembersDataUpdated {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CMsgClientToGCRequestGuildMembership: MessageFns<CMsgClientToGCRequestGuildMembership> = {
  encode(_: CMsgClientToGCRequestGuildMembership, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): CMsgClientToGCRequestGuildMembership {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CMsgClientToGCRequestGuildMembershipResponse: MessageFns<CMsgClientToGCRequestGuildMembershipResponse> = {
  encode(
    ...
    if (message.guildMemberships !== undefined) {
      CMsgAccountGuildMemberships.encode(message.guildMemberships, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): CMsgClientToGCRequestGuildMembershipResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CMsgGCToClientGuildMembershipUpdated: MessageFns<CMsgGCToClientGuildMembershipUpdated> = {
  encode(message: CMsgGCToClientGuildMembershipUpdated, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.guildMemberships !== undefined) {
      CMsgAccountGuildMemberships.encode(message.guildMemberships, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): CMsgGCToClientGuildMembershipUpdated {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CMsgClientToGCJoinGuild: MessageFns<CMsgClientToGCJoinGuild> = {
  encode(message: CMsgClientToGCJoinGuild, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.guildId !== 0) {
      writer.uint32(8).uint32(message.guildId);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CMsgClientToGCJoinGuild {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CMsgClientToGCJoinGuildResponse: MessageFns<CMsgClientToGCJoinGuildResponse> = {
  encode(message: CMsgClientToGCJoinGuildResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.result !== 0) {
      writer.uint32(8).int32(message.result);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CMsgClientToGCJoinGuildResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CMsgClientToGCLeaveGuild: MessageFns<CMsgClientToGCLeaveGuild> = {
  encode(message: CMsgClientToGCLeaveGuild, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.guildId !== 0) {
      writer.uint32(8).uint32(message.guildId);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CMsgClientToGCLeaveGuild {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CMsgClientToGCLeaveGuildResponse: MessageFns<CMsgClientToGCLeaveGuildResponse> = {
  encode(message: CMsgClientToGCLeaveGuildResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.result !== 0) {
      writer.uint32(8).int32(message.result);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CMsgClientToGCLeaveGuildResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CMsgClientToGCKickGuildMember: MessageFns<CMsgClientToGCKickGuildMember> = {
  encode(message: CMsgClientToGCKickGuildMember, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.guildId !== 0) {
      writer.uint32(8).uint32(message.guildId);
    }
    if (message.targetAccountId !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CMsgClientToGCKickGuildMember {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CMsgClientToGCKickGuildMemberResponse: MessageFns<CMsgClientToGCKickGuildMemberResponse> = {
  encode(message: CMsgClientToGCKickGuildMemberResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.result !== 0) {
      writer.uint32(8).int32(message.result);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CMsgClientToGCKickGuildMemberResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CMsgClientToGCSetGuildMemberRole: MessageFns<CMsgClientToGCSetGuildMemberRole> = {
  encode(message: CMsgClientToGCSetGuildMemberRole, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.guildId !== 0) {
      writer.uint32(8).uint32(message.guildId);
    }
    if (message.targetAccountId !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CMsgClientToGCSetGuildMemberRole {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CMsgClientToGCSetGuildMemberRoleResponse: MessageFns<CMsgClientToGCSetGuildMemberRoleResponse> = {
  encode(message: CMsgClientToGCSetGuildMemberRoleResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.result !== 0) {
      writer.uint32(8).int32(message.result);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CMsgClientToGCSetGuildMemberRoleResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CMsgClientToGCInviteToGuild: MessageFns<CMsgClientToGCInviteToGuild> = {
  encode(message: CMsgClientToGCInviteToGuild, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.guildId !== 0) {
      writer.uint32(8).uint32(message.guildId);
    }
    if (message.targetAccountId !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CMsgClientToGCInviteToGuild {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CMsgClientToGCInviteToGuildResponse: MessageFns<CMsgClientToGCInviteToGuildResponse> = {
  encode(message: CMsgClientToGCInviteToGuildResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.result !== 0) {
      writer.uint32(8).int32(message.result);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CMsgClientToGCInviteToGuildResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CMsgClientToGCDeclineInviteToGuild: MessageFns<CMsgClientToGCDeclineInviteToGuild> = {
  encode(message: CMsgClientToGCDeclineInviteToGuild, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.guildId !== 0) {
      writer.uint32(8).uint32(message.guildId);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CMsgClientToGCDeclineInviteToGuild {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CMsgClientToGCDeclineInviteToGuildResponse: MessageFns<CMsgClientToGCDeclineInviteToGuildResponse> = {
  encode(message: CMsgClientToGCDeclineInviteToGuildResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.result !== 0) {
      writer.uint32(8).int32(message.result);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CMsgClientToGCDeclineInviteToGuildResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CMsgClientToGCAcceptInviteToGuild: MessageFns<CMsgClientToGCAcceptInviteToGuild> = {
  encode(message: CMsgClientToGCAcceptInviteToGuild, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.guildId !== 0) {
      writer.uint32(8).uint32(message.guildId);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CMsgClientToGCAcceptInviteToGuild {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CMsgClientToGCAcceptInviteToGuildResponse: MessageFns<CMsgClientToGCAcceptInviteToGuildResponse> = {
  encode(message: CMsgClientToGCAcceptInviteToGuildResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.result !== 0) {
      writer.uint32(8).int32(message.result);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CMsgClientToGCAcceptInviteToGuildResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CMsgClientToGCCancelInviteToGuild: MessageFns<CMsgClientToGCCancelInviteToGuild> = {
  encode(message: CMsgClientToGCCancelInviteToGuild, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.guildId !== 0) {
      writer.uint32(8).uint32(message.guildId);
    }
    if (message.targetAccountId !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CMsgClientToGCCancelInviteToGuild {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CMsgClientToGCCancelInviteToGuildResponse: MessageFns<CMsgClientToGCCancelInviteToGuildResponse> = {
  encode(message: CMsgClientToGCCancelInviteToGuildResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.result !== 0) {
      writer.uint32(8).int32(message.result);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CMsgClientToGCCancelInviteToGuildResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CMsgClientToGCAddGuildRole: MessageFns<CMsgClientToGCAddGuildRole> = {
  encode(message: CMsgClientToGCAddGuildRole, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.guildId !== 0) {
      writer.uint32(8).uint32(message.guildId);
    }
    if (message.roleName !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CMsgClientToGCAddGuildRole {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CMsgClientToGCAddGuildRoleResponse: MessageFns<CMsgClientToGCAddGuildRoleResponse> = {
  encode(message: CMsgClientToGCAddGuildRoleResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.result !== 0) {
      writer.uint32(8).int32(message.result);
    }
    if (message.roleId !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CMsgClientToGCAddGuildRoleResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CMsgClientToGCModifyGuildRole: MessageFns<CMsgClientToGCModifyGuildRole> = {
  encode(message: CMsgClientToGCModifyGuildRole, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.guildId !== 0) {
      writer.uint32(8).uint32(message.guildId);
    }
    if (message.roleId !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CMsgClientToGCModifyGuildRole {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CMsgClientToGCModifyGuildRoleResponse: MessageFns<CMsgClientToGCModifyGuildRoleResponse> = {
  encode(message: CMsgClientToGCModifyGuildRoleResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.result !== 0) {
      writer.uint32(8).int32(message.result);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CMsgClientToGCModifyGuildRoleResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CMsgClientToGCRemoveGuildRole: MessageFns<CMsgClientToGCRemoveGuildRole> = {
  encode(message: CMsgClientToGCRemoveGuildRole, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.guildId !== 0) {
      writer.uint32(8).uint32(message.guildId);
    }
    if (message.roleId !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CMsgClientToGCRemoveGuildRole {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CMsgClientToGCRemoveGuildRoleResponse: MessageFns<CMsgClientToGCRemoveGuildRoleResponse> = {
  encode(message: CMsgClientToGCRemoveGuildRoleResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.result !== 0) {
      writer.uint32(8).int32(message.result);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CMsgClientToGCRemoveGuildRoleResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CMsgClientToGCSetGuildRoleOrder: MessageFns<CMsgClientToGCSetGuildRoleOrder> = {
  encode(message: CMsgClientToGCSetGuildRoleOrder, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.guildId !== 0) {
      writer.uint32(8).uint32(message.guildId);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CMsgClientToGCSetGuildRoleOrder {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CMsgClientToGCSetGuildRoleOrderResponse: MessageFns<CMsgClientToGCSetGuildRoleOrderResponse> = {
  encode(message: CMsgClientToGCSetGuildRoleOrderResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.result !== 0) {
      writer.uint32(8).int32(message.result);
    }
    writer.uint32(18).fork();
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CMsgClientToGCSetGuildRoleOrderResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CMsgClientToGCGuildFeedRequest: MessageFns<CMsgClientToGCGuildFeedRequest> = {
  encode(message: CMsgClientToGCGuildFeedRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.guildId !== 0) {
      writer.uint32(8).uint32(message.guildId);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CMsgClientToGCGuildFeedRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2: {
          ...
          message.lastSeenId = reader.uint64().toString();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
...
export const CMsgClientToGCRequestGuildFeedResponse: MessageFns<CMsgClientToGCRequestGuildFeedResponse> = {
  encode(message: CMsgClientToGCRequestGuildFeedResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.result !== 0) {
      writer.uint32(8).int32(message.result);
    }
    if (message.guildId !== 0) {
    ...
    for (const v of message.feedEvents) {
      CMsgGuildFeedEvent.encode(v!, writer.uint32(26).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): CMsgClientToGCRequestGuildFeedResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CMsgGCToClientGuildFeedUpdated: MessageFns<CMsgGCToClientGuildFeedUpdated> = {
  encode(message: CMsgGCToClientGuildFeedUpdated, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.guildId !== 0) {
      writer.uint32(8).uint32(message.guildId);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CMsgGCToClientGuildFeedUpdated {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CMsgClientToGCAddPlayerToGuildChat: MessageFns<CMsgClientToGCAddPlayerToGuildChat> = {
  encode(message: CMsgClientToGCAddPlayerToGuildChat, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.guildId !== 0) {
      writer.uint32(8).uint32(message.guildId);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CMsgClientToGCAddPlayerToGuildChat {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CMsgClientToGCAddPlayerToGuildChatResponse: MessageFns<CMsgClientToGCAddPlayerToGuildChatResponse> = {
  encode(message: CMsgClientToGCAddPlayerToGuildChatResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.result !== 0) {
      writer.uint32(8).int32(message.result);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CMsgClientToGCAddPlayerToGuildChatResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CMsgFindGuildByTagResponse: MessageFns<CMsgFindGuildByTagResponse> = {
  encode(message: CMsgFindGuildByTagResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.result !== 0) {
      writer.uint32(8).int32(message.result);
    }
    if (message.guildId !== 0) {
    ...
    if (message.guildSummary !== undefined) {
      CMsgGuildSummary.encode(message.guildSummary, writer.uint32(26).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): CMsgFindGuildByTagResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CMsgSearchForOpenGuildsResponse: MessageFns<CMsgSearchForOpenGuildsResponse> = {
  encode(message: CMsgSearchForOpenGuildsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.result !== 0) {
      writer.uint32(8).int32(message.result);
    }
    for (const v of message.searchResults) {
      CMsgSearchForOpenGuildsResponse_SearchResult.encode(v!, writer.uint32(18).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CMsgSearchForOpenGuildsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CMsgSearchForOpenGuildsResponse_SearchResult: MessageFns<CMsgSearchForOpenGuildsResponse_SearchResult> = {
  encode(
    message: CMsgSearchForOpenGuildsResponse_SearchResult,
    writer: BinaryWriter = new BinaryWriter(),
  ): BinaryWriter {
    if (message.guildId !== 0) {
      writer.uint32(8).uint32(message.guildId);
    ...
    if (message.guildSummary !== undefined) {
      CMsgGuildSummary.encode(message.guildSummary, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): CMsgSearchForOpenGuildsResponse_SearchResult {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CMsgClientToGCReportGuildContent: MessageFns<CMsgClientToGCReportGuildContent> = {
  encode(message: CMsgClientToGCReportGuildContent, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.guildId !== 0) {
      writer.uint32(8).uint32(message.guildId);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CMsgClientToGCReportGuildContent {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CMsgClientToGCReportGuildContentResponse: MessageFns<CMsgClientToGCReportGuildContentResponse> = {
  encode(message: CMsgClientToGCReportGuildContentResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.result !== 0) {
      writer.uint32(8).int32(message.result);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CMsgClientToGCReportGuildContentResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CMsgClientToGCRequestAccountGuildPersonaInfo: MessageFns<CMsgClientToGCRequestAccountGuildPersonaInfo> = {
  encode(
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CMsgClientToGCRequestAccountGuildPersonaInfo {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CMsgClientToGCRequestAccountGuildPersonaInfoResponse: MessageFns<
...
> = {
  encode(
    ...
    if (message.personaInfo !== undefined) {
      CMsgAccountGuildsPersonaInfo.encode(message.personaInfo, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): CMsgClientToGCRequestAccountGuildPersonaInfoResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CMsgClientToGCRequestAccountGuildPersonaInfoBatch: MessageFns<
...
> = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CMsgClientToGCRequestAccountGuildPersonaInfoBatch {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CMsgClientToGCRequestAccountGuildPersonaInfoBatchResponse: MessageFns<
...
> = {
  encode(
    ...
    for (const v of message.personaInfos) {
      CMsgAccountGuildsPersonaInfo.encode(v!, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): CMsgClientToGCRequestAccountGuildPersonaInfoBatchResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
